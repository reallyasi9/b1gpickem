...
type makePickCmd struct {
	...
	Picks  map[string][]string `arg:"" help:"Mapping of streaker Luke name to team other names picked by the streaker for the week. An empty team name value will clear the streaker's pick for the week.`
}

...
// CLI is a structure defining commands and arguments for PYP. See kong documentation for more information.
var CLI struct {
	globalCmd
	...
	Simulate simulateCmd `cmd:"" help:"Simulate games to help pick your pony."`
}
